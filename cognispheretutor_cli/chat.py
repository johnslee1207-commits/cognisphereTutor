...
def register(app: typer.Typer) -> None:
    ...
    def chat(
        ...
        """Enter interactive chat REPL. Use `cognispheretutor run` for single-turn execution."""
