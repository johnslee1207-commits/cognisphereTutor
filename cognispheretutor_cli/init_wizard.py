"""Interactive setup helpers used by ``cognispheretutor init``.
...
from cognispheretutor.services.llm.config import get_token_limit_kwargs
from cognispheretutor.services.provider_registry import PROVIDERS, ProviderSpec, find_by_name
...
# ``cognispheretutor.services.config.provider_runtime``. Adding a new featured entry
...
# ``cognispheretutor.services.config.provider_runtime``. Each entry below describes
