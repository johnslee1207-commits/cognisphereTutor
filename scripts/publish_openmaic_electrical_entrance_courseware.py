...
def courseware_scenes(course_id: str) -> list[dict[str, Any]]:
    scene_specs: list[dict[str, Any]] = [
        ...
        quiz(
            ...
            [
                q(
                    ...
                    ["6", "8", "12", "16"],
                    1,
                    "两边加 4 得 3x=24，所以 x=8。",
                ),
                q(
                    "如果 y = 2x + 1，当 x = 5 时 y 等于多少？",
                    ["10", "11", "12", "15"],
                    1,
                    "代入 x=5，y=10+1=11。",
                ),
        ...
        quiz(
            ...
            [
                q(
                    "120V、2A 求功率 P，应使用哪个公式？",
                    ["R=V/I", "P=V*I", "I=V/R", "V=I/R"],
                    1,
                    "功率用 P=V*I。",
                ),
                q(
                    "24V、6A 求电阻 R，答案是多少？",
                    ["4 ohms", "30 ohms", "144 watts", "18 amps"],
                    0,
                    "R=V/I=24/6=4 ohms。",
                ),
            ],
        ...
        quiz(
            ...
            [
                q(
                    ...
                    ["4", "5", "6", "12"],
                    2,
                    "两边减 7 得 2x=12，所以 x=6。",
                ),
                q(
                    "如果 3 个小捆对应 2 个大捆，总份数是多少？",
                    ["2", "3", "5", "6"],
                    2,
                    "比例 3:2 的总份数是 5。",
                ),
        ...
        quiz(
            ...
            [
                ...
                q(
                    "如果每小时完成 9 题，4 小时完成多少题？",
                    ["13", "27", "36", "45"],
                    2,
                    "9 x 4 = 36。",
                ),
                q(
                    "阅读题问 according to the passage，应优先依据什么？",
                    ["原文证据", "个人经验", "专业猜测", "最长选项"],
                    0,
                    "according to the passage 要求回到原文。",
                ),
                q(
                    "两个直接咬合齿轮方向如何？",
                    ["相同", "相反", "都向上", "都向下"],
