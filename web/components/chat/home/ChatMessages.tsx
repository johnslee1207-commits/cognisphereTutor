...
/** "cognisphereTutor_Introduction.pdf" → "cognisphereTutor Introduction" — the card title
  ...
  return (
    <>
      {/* Activity block pinned to the TOP: the status header
          ("cognisphereTutor Exploring… · 8s" → "cognisphereTutor responded. · 10s") with
          the exploring trace nested beneath it — expanded while cognisphereTutor is
