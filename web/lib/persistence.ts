...
const STORAGE_PREFIX = "cognispheretutor_";
...
/**
 * Clear all cognisphereTutor data from localStorage
 */
export function clearAllStorage(): void {
  ...
  try {
    ...
    console.info(`Cleared ${keysToRemove.length} cognisphereTutor storage items`);
  } catch (error) {
