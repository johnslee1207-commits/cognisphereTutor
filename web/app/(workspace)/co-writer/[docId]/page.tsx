...
const SPLIT_RATIO_KEY = "cognispheretutor.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "cognispheretutor.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "cognispheretutor.co_writer.draft.";
