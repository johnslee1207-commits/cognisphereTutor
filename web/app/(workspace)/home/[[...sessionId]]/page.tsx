...
export default function ChatPage() {
  ...
  // How many times cognisphereTutor may consult the selected agent this turn. Seeded
...
function SubagentTabWatcher({
  ...
  useEffect(() => {
    // Group by turn so all of one turn's consults (cognisphereTutor may ask the agent
