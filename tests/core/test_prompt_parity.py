...
AGENTS_DIR = PROJECT_ROOT / "cognispheretutor" / "agents"
# Modules that live outside cognispheretutor/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "cognispheretutor" / "book",
    PROJECT_ROOT / "cognispheretutor" / "co_writer",
)
