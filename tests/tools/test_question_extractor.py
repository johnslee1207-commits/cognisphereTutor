...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "cognispheretutor.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "cognispheretutor.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "cognispheretutor.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "cognispheretutor.services.llm.config": {"get_llm_config": lambda: None},
        "cognispheretutor.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
