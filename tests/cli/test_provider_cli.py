...
PROVIDER_CMD = (ROOT / "cognispheretutor_cli" / "provider_cmd.py").read_text(encoding="utf-8")
CLI_README = (ROOT / "cognispheretutor_cli" / "README.md").read_text(encoding="utf-8")
