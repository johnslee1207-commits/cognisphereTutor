"""CLI smoke tests for ``cognispheretutor notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch cognisphereTutorApp methods to use the shared fake manager."""
    ...
    from cognispheretutor.app import facade

    monkeypatch.setattr(facade.cognisphereTutorApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.cognisphereTutorApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.cognisphereTutorApp, "add_record", _add_record)
    monkeypatch.setattr(facade.cognisphereTutorApp, "update_record", _update_record)
    monkeypatch.setattr(facade.cognisphereTutorApp, "remove_record", _remove_record)
