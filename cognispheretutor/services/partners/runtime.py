...
from cognispheretutor.multi_user.paths import user_context
...
from cognispheretutor.partners.helpers import detect_image_mime
...
from cognispheretutor.services.partners.workspace import ensure_partner_workspace, read_soul
...
class PartnerRunner:
    ...
    def _build_context(self, msg: InboundMessage) -> UnifiedContext:
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are cognisphereTutor")
