...
stage. An engine turns bytes/path into a :class:`~cognispheretutor.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`cognispheretutor.services.parsing.cache.load_ir` and writes
