...
def builtin_pageindex_server() -> MCPServerConfig | None:
    ...
    from cognispheretutor.services.rag.pipelines.pageindex.config import get_pageindex_config
    ...
    return MCPServerConfig(
        ...
        tool_timeout=120,
        # remove_document is the one api-proxy tool cognisphereTutor blocks: an agent
