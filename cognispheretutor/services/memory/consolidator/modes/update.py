...
from cognispheretutor.services.memory import paths
from cognispheretutor.services.memory import snapshot as snap
from cognispheretutor.services.memory.consolidator.chunker import (
    chunk_with_boundary,
)
from cognispheretutor.services.memory.consolidator.meta import (
    load_l2_meta,
    load_l3_meta,
    save_l2_meta,
    save_l3_meta,
)
from cognispheretutor.services.memory.consolidator.modes._runtime import (
    OnEvent,
    call_llm,
    emit,
    load_doc,
...
from cognispheretutor.services.memory.ops import AddOp
from cognispheretutor.services.memory.ops import apply as apply_ops
from cognispheretutor.services.memory.paths import L3Slot, Surface
from cognispheretutor.services.memory.settings import load_memory_settings
    ...
    *,
    ...
    if not new_entities:
        ...
        if settings.merge.auto_after_update:
            from cognispheretutor.services.memory.consolidator.modes.merge import run_merge
    ...
    if settings.dedup.auto_after_update and facts_added > 0:
        ...
        from cognispheretutor.services.memory.consolidator.modes.dedup import run_dedup
...
def _load_all_l2_docs() -> dict[str, Document]:
    from cognispheretutor.services.memory.document import parse
