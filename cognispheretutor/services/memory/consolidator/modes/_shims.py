"""Legacy public-API shims for :mod:`cognispheretutor.services.memory.store`.
...
from cognispheretutor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from cognispheretutor.services.memory.document import parse, serialize
from cognispheretutor.services.memory.ops import ApplyReport, Op
