...
from cognispheretutor.services.memory import consolidator, paths, trace
from cognispheretutor.services.memory.consolidator import ConsolidateResult, OnEvent
from cognispheretutor.services.memory.document import Document, parse, serialize
from cognispheretutor.services.memory.ops import AddOp, ApplyReport, EditOp
from cognispheretutor.services.memory.ops import apply as ops_apply
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from cognispheretutor.services.memory.consolidator import _parse_ops_response
