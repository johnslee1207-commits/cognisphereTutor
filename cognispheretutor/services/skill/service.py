...
* builtin — shipped with the product under ``cognispheretutor/skills/builtin/``,
...
:mod:`cognispheretutor.services.persona` and are eagerly injected because a persona
