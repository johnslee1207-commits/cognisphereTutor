...
from cognispheretutor.services.voice.adapters import get_stt_adapter, get_tts_adapter
from cognispheretutor.services.voice.base import VoiceProviderError, strip_markdown_for_speech
