...
GraphRAG's global/local/drift/basic retrieval. cognisphereTutor parses documents to
...
GraphRAG is an optional dependency (``pip install 'cognispheretutor[graphrag]'``). The
