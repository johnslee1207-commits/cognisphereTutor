...
deleting the KB only drops cognisphereTutor's pointer (handled by the manager) and must
...
from cognispheretutor.services.rag.provider_binding import load_kb_config_entry
...
class LightRagServerPipeline:
    ...
    async def initialize(self, kb_name: str, file_paths: List[str], **kwargs) -> bool:
        raise RuntimeError(
            ...
            "cognisphereTutor does not build or store their index. Add documents on the "
