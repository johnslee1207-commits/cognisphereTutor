"""LlamaIndex embedding adapter backed by cognisphereTutor's embedding service."""
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for cognisphereTutor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for cognisphereTutor's current embedding config."""
