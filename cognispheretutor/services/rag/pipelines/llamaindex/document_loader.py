...
document-parse bridge (``cognispheretutor/services/parsing``), so the engine the user
...
from cognispheretutor.services.embedding import get_embedding_client
from cognispheretutor.services.llm.client import get_llm_client
...
class LlamaIndexDocumentLoader:
    ...
    def _parse_document(self, file_path: Path) -> tuple[str, list[_ImageSource]]:
        ...
        """
        from cognispheretutor.services.parsing import ParserError, get_parse_service
