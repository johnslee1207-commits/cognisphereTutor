"""Persistent subagent session ids — continuity across cognisphereTutor turns.
...
the agent keeps the full context of everything cognisphereTutor — and the user, from
