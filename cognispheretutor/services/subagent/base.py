...
from cognispheretutor.services.subagent.types import ConsultResult, DetectResult, SubagentEvent
...
class SubagentBackend(ABC):
    ...
    async def consult(
        ...
        *,
        ...
        subagent keeps context across cognisphereTutor's successive questions); the
