...
if TYPE_CHECKING:
    from cognispheretutor.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/cognisphereTutor",
    "X-OpenRouter-Title": "cognisphereTutor",
}
