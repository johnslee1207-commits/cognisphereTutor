...
:class:`~cognispheretutor.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`cognispheretutor.capabilities.obsidian.vault` operations.
...
from cognispheretutor.capabilities.obsidian import vault as vault_ops
