...
def _mastery_turn_directive(context: UnifiedContext) -> str:
    ...
    if language.startswith("zh"):
        return (
            ...
            "返回的 Mermaid 图示/分步 storyboard 放入面向学习者的讲解；不要只用文字替代。\n"
    ...
    return (
        ...
        "first and include its returned Mermaid diagram/storyboard in the "
        "learner-facing explanation; do not replace it with text-only teaching.\n"
