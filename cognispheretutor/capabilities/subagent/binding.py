...
Mirrors :mod:`cognispheretutor.capabilities.obsidian.binding`: the binding is derived
...
def _resolve(context: UnifiedContext) -> dict[str, str] | None:
    from cognispheretutor.multi_user.knowledge_access import resolve_kb_metadata
