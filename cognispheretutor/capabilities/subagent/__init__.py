...
through :mod:`cognispheretutor.services.subagent` and streaming its native run to the
...
from cognispheretutor.capabilities.subagent.capability import SubagentCapability
from cognispheretutor.capabilities.subagent.tools import (
    SUBAGENT_TOOL_NAMES,
    SUBAGENT_TOOL_TYPES,
    ConsultSubagentTool,
)
