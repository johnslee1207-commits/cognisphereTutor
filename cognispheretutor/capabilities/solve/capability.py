...
(:class:`cognispheretutor.capabilities.solve.loop.SolveLoopCapability`) mounts the
...
from cognispheretutor.capabilities.solve.session import DEFAULT_MAX_REPLANS
from cognispheretutor.capabilities.solve.tools import SOLVE_TOOL_NAMES
...
from cognispheretutor.services.config.capabilities_settings import get_solve_params
