...
:class:`cognispheretutor.capabilities.solve.capability.DeepSolveCapability`.
"""
...
from cognispheretutor.capabilities.solve.session import DEFAULT_MAX_REPLANS, get_session
