...
to :mod:`cognispheretutor.core.agentic` and the shared tool-composition policy.
"""
...
from cognispheretutor.core.agentic.labels import find_inline_labels
from cognispheretutor.core.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
from cognispheretutor.core.agentic.usage import record_streamed_usage
...
from cognispheretutor.services.config import parse_language
from cognispheretutor.services.llm import get_llm_config, prepare_multimodal_messages
...
from cognispheretutor.services.prompt.language import append_language_directive
from cognispheretutor.services.sandbox import exec_capability_available
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="cognisphereTutor Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="cognisphereTutor Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
