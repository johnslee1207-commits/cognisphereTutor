...
from cognispheretutor.agents.chat.agent_loop import AgentLoop
from cognispheretutor.agents.chat.prompt_blocks import ChatPromptAssembler
from cognispheretutor.capabilities import (
    LoopCapability,
    active_loop_capabilities,
    any_exclusive_capability_active,
)
from cognispheretutor.core.agentic import (
    DispatchOutcome,
    LLMClientConfig,
    UsageTracker,
...
from cognispheretutor.core.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
...
from cognispheretutor.services.config import get_chat_params
...
from cognispheretutor.services.llm.context_window import resolve_effective_context_window
from cognispheretutor.services.prompt import get_prompt_manager
from cognispheretutor.tools.builtin import PARTNER_BUILTIN_TOOL_NAMES
...
def _drop_unconfigured_generation_tools(tools: list[str]) -> list[str]:
    ...
    if not present:
        return tools
    try:
        from cognispheretutor.services.config.model_catalog import get_model_catalog_service
...
class AgenticChatPipeline:
    ...
    async def _prepare_deferred_tools(self, context: UnifiedContext) -> None:
        ...
        try:
            from cognispheretutor.services.mcp import get_mcp_manager, load_loaded_tools
            ...
            if self._pageindex_docs:
                from cognispheretutor.services.mcp.pageindex_server import PAGEINDEX_SERVER_NAME
    ...
    async def _exec_allowed(self, context: UnifiedContext) -> bool:
        try:
            from cognispheretutor.services.sandbox import IsolationLevel, get_sandbox_service
            ...
            if level is IsolationLevel.SYSTEM:
                ...
                from cognispheretutor.multi_user.tool_access import exec_override
    ...
    async def _execute_tool_call(
        ...
        *,
        ...
        from cognispheretutor.core.agentic import execute_tool_call
    ...
    def _estimate_messages_tokens(messages: list[dict[str, Any]]) -> int:
        from cognispheretutor.services.session.context_builder import count_tokens
