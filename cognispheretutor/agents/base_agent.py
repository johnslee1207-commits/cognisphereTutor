...
from cognispheretutor.config.settings import settings
from cognispheretutor.logging import LLMStats
from cognispheretutor.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"cognispheretutor.{logger_name}")
