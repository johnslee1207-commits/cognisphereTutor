"""Runtime home resolution for installed and source cognisphereTutor runs."""
...
COGNISPHERETUTOR_HOME_ENV = "COGNISPHERETUTOR_HOME"
...
def get_runtime_home(home: str | Path | None = None) -> Path:
    ...
    2. ``COGNISPHERETUTOR_HOME`` environment variable.
    ...
    raw = home if home is not None else os.getenv(COGNISPHERETUTOR_HOME_ENV)
