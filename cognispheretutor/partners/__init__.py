"""Partners — IM-connected companions driven by the cognisphereTutor chat agent loop.
...
``cognispheretutor.services.partners`` and reuses the chat capability's agent loop
