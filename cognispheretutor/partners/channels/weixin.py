...
from cognispheretutor.partners.config.paths import get_media_dir, get_runtime_subdir
from cognispheretutor.partners.config.schema import DeliveryOverrides
from cognispheretutor.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"cognispheretutor-{uuid.uuid4().hex[:12]}"
