...
from cognispheretutor.agents.question import AgentCoordinator
from cognispheretutor.api.utils.task_id_manager import TaskIDManager
from cognispheretutor.logging import (
    ProcessLogEvent,
    bind_log_context,
...
from cognispheretutor.tools.question import mimic_exam_questions
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="cognispheretutor.question.stdout",
