...
from cognispheretutor.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints
...
async def list_builtin_tools() -> ToolsListResponse:
    ...
    from cognispheretutor.capabilities import capability_tool_owners
