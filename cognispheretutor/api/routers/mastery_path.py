...
from cognispheretutor.learning import policy as learning_policy
from cognispheretutor.learning import prompts as learning_prompts
...
async def generate_from_notebook(book_id: str, body: GenerateFromNotebookRequest):
    ...
    from cognispheretutor.services.llm import complete
