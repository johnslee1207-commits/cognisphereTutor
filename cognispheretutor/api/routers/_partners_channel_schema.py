...
Why live here vs inside ``cognispheretutor.partners.channels``?
...
from cognispheretutor.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from cognispheretutor.partners.channels.registry import discover_all_with_errors
