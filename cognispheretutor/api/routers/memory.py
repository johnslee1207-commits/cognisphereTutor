...
async def reset_doc(layer: str, key: str):
    ...
    from cognispheretutor.services.memory.consolidator.runs import get_run_manager
...
async def start_run(req: RunStartRequest):
    ...
    from cognispheretutor.services.memory.consolidator.runs import (
        RunBusyError,
        get_run_manager,
    )
...
async def get_doc_lines(layer: str, key: str):
    ...
    from cognispheretutor.services.memory.consolidator.line_doc import render_view
    from cognispheretutor.services.memory.document import Document, parse
...
async def get_memory_settings_endpoint():
    ...
    from cognispheretutor.services.memory.settings import memory_settings_dict
...
async def get_trace(surface: str, limit: int = 200, offset: int = 0):
    ...
    from cognispheretutor.services.memory.trace import iter_since
