...
from cognispheretutor.services.config import load_auth_settings
...
from cognispheretutor.multi_user.context import set_current_user, user_from_token_payload
from cognispheretutor.multi_user.paths import local_admin_user
from cognispheretutor.services.auth import (
    AUTH_ENABLED,
    POCKETBASE_ENABLED,
    TOKEN_EXPIRE_HOURS,
    TokenPayload,
...
def _local_admin_token_payload() -> TokenPayload:
    ...
    ``cognispheretutor/multi_user/paths.py``.
    """
...
async def update_profile(
    ...
    from cognispheretutor.multi_user.identity import delete_avatar_file
