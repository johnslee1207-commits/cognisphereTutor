...
from cognispheretutor.core.i18n import current_language
from cognispheretutor.i18n.metadata_i18n import localized_description, tool_description_i18n
...
async def build_tool_options(
    *, exclude_builtin: set[str] | None = None
    ...
    from cognispheretutor.tools.builtin import CONFIGURABLE_BUILTIN_TOOL_NAMES
