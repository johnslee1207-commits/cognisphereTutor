...
runs through the :mod:`cognispheretutor.services.sandbox` layer rather than a raw
...
# NOTE: ``cognispheretutor.services.sandbox`` is imported lazily inside ``execute``
# (not at module top). This tool is loaded by ``cognispheretutor.tools.builtin``,
