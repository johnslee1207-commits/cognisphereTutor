...
from cognispheretutor.api.routers.mastery_path import router
...
def app(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "cognispheretutor.api.routers.mastery_path.LearningStore",
...
class TestGenerateFromNotebook:
    ...
    @patch("cognispheretutor.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("cognispheretutor.api.routers.mastery_path.get_ui_language", return_value="en")
    @patch("cognispheretutor.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("cognispheretutor.api.routers.mastery_path.get_ui_language", return_value="zh")
    @patch("cognispheretutor.services.llm.complete", new_callable=AsyncMock)
