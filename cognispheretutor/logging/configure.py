"""cognisphereTutor logging bootstrap."""
...
_CONFIGURED = False
_MANAGED_ATTR = "_cognispheretutor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    if config.file_output:
        ...
        file_handler = _managed(
            RotatingFileHandler(
                log_dir / "cognispheretutor.jsonl",
    ...
    logging.getLogger("cognispheretutor").setLevel(logging.DEBUG)
    logging.getLogger("cognispheretutor").propagate = True
