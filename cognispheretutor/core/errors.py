...
class cognisphereTutorError(Exception):
    """Base class for all application errors in cognisphereTutor."""
...
class ConfigurationError(cognisphereTutorError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(cognisphereTutorError):
    """Raised when input validation fails."""

    pass


class ServiceError(cognisphereTutorError):
