...
from cognispheretutor.services.config import load_system_settings
from cognispheretutor.services.llm import get_token_limit_kwargs, supports_tools
from cognispheretutor.services.llm.reasoning_params import (
    build_openai_compatible_reasoning_kwargs,
)
from cognispheretutor.services.provider_registry import find_by_name
...
def _build_anthropic_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from cognispheretutor.services.llm.provider_core import AnthropicProvider
...
def _build_codex_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from cognispheretutor.services.llm.provider_core import OpenAICodexProvider
...
def _build_copilot_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from cognispheretutor.services.llm.provider_core import GitHubCopilotProvider
