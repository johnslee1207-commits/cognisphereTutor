...
:func:`~cognispheretutor.core.agentic.labeled_step.run_labeled_step` call, after
which the loop:
...
from cognispheretutor.core.agentic.labeled_step import LabeledStepResult, run_labeled_step
from cognispheretutor.core.agentic.labels import LABEL_UNKNOWN, find_inline_labels
