...
Wraps :class:`cognispheretutor.agents.visualize.pipeline.VisualizePipeline` with
...
class FigureGenerator(BlockGenerator):
    ...
    async def _generate(
        ...
        try:
            from cognispheretutor.agents.visualize.models import ReviewResult
            from cognispheretutor.agents.visualize.pipeline import VisualizePipeline
            from cognispheretutor.agents.visualize.utils import validate_visualization
