# cognisphereTutor v1.4.12 Release Notes
...
cognisphereTutor offloads retrieval to it over HTTP — no local index is built. Each KB
...
`pip install 'cognispheretutor[parse-pymupdf4llm]'`; engines that need packages can now be
...
Drop-in from v1.4.11: `pip install -U cognispheretutor`; Docker users pull
`ghcr.io/hkuds/cognispheretutor:latest`. No migrations. Existing LlamaIndex knowledge bases
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.11...v1.4.12
