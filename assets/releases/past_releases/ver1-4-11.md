# cognisphereTutor v1.4.11 Release Notes
...
[CONTAINERIZATION.md](https://github.com/HKUDS/cognisphereTutor/blob/main/CONTAINERIZATION.md).
...
Drop-in from v1.4.10: `pip install -U cognispheretutor`; Docker users pull
`ghcr.io/hkuds/cognispheretutor:latest`. No migrations, no configuration changes. The one
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.10...v1.4.11
