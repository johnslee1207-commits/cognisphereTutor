# cognisphereTutor v1.4.9 Release Notes
...
When cognisphereTutor grades a question inside a Mastery Path, the attempt — the
...
Drop-in from v1.4.8: `pip install -U cognispheretutor`; Docker users pull
`ghcr.io/hkuds/cognispheretutor:latest`. No migrations, no configuration changes.

**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.8...v1.4.9
