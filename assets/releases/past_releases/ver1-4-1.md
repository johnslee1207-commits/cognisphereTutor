# cognisphereTutor v1.4.1 Release Notes
...
multimodal image-fallback fix for providers cognisphereTutor has no vision entry for.
...
## Upgrade Notes
- Drop-in from v1.4.0: `pip install -U cognispheretutor`; Docker users pull
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.0...v1.4.1
