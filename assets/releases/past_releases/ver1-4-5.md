# cognisphereTutor v1.4.5 Release Notes
...
A new loop-plugin framework (`cognispheretutor/loop_plugins/`) lets a feature
...
- Drop-in from v1.4.4: `pip install -U cognispheretutor`; Docker users pull
  `ghcr.io/hkuds/cognispheretutor:latest`. No migrations — existing learning
  progress loads as-is.
- Windows launch scripts moved into `scripts/`: run
  `scripts\start_backend.bat` / `scripts\start_frontend.bat`.

**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.4...v1.4.5
