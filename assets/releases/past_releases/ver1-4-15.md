# cognisphereTutor v1.4.15 Release Notes
...
Drop-in from v1.4.14: `pip install -U cognispheretutor`; Docker users pull `ghcr.io/hkuds/cognispheretutor:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is.

**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.14...v1.4.15
