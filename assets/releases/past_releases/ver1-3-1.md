# cognisphereTutor v1.3.1 Release Notes
...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and cognisphereTutor
...
- **Embedding responses are validated before use** - cognisphereTutor now rejects
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.3.0...v1.3.1
