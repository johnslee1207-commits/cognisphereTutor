# cognisphereTutor v1.2.1 Release Notes
...
- **CLI** — `/regenerate` (alias `/retry`) inside the `cognispheretutor chat` REPL.
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.2.0...v1.2.1
