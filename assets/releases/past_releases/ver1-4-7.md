# cognisphereTutor v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something cognisphereTutor can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running cognisphereTutor — nothing is
...
- cognisphereTutor detects an installed **Claude Code** or **Codex** and connects it as
...
- Drop-in from v1.4.6: `pip install -U cognispheretutor`; Docker users pull
...
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running cognisphereTutor — they are detected, never installed for you.
- The docs at [cognispheretutor.info](https://cognispheretutor.info/) are still catching up to
  the recent releases and will be refreshed shortly.

**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.6...v1.4.7
