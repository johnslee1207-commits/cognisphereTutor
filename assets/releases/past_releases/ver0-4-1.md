# 🔧 cognisphereTutor v0.4.1 Release Notes
...
**Removed `cognispheretutor/core` module** - All functionality migrated to `cognispheretutor/services`:

| Old Import | New Import |
|:---|:---|
| `from cognispheretutor.core.core import load_config_with_main` | `from cognispheretutor.services.config import load_config_with_main` |
| `from cognispheretutor.core.llm_factory import llm_complete` | `from cognispheretutor.services.llm import complete` |
| `from cognispheretutor.core.prompt_manager import get_prompt_manager` | `from cognispheretutor.services.prompt import get_prompt_manager` |
| `from cognispheretutor.core.logging import get_logger` | `from cognispheretutor.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v0.4.0...v0.4.1
