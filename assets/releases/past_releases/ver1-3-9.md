# cognisphereTutor v1.3.9 Release Notes
...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; cognisphereTutor sends the provider-specific disable
  signal instead.
...
- **`cognispheretutor start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `cognispheretutor start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.3.8...v1.3.9
