# cognisphereTutor v1.4.10 Release Notes
...
### Run cognisphereTutor in a container, rootless-ready

A new [CONTAINERIZATION.md](https://github.com/HKUDS/cognisphereTutor/blob/main/CONTAINERIZATION.md)
...
per-request access log is now disabled on **every** launch path (`cognispheretutor
...
Drop-in from v1.4.9: `pip install -U cognispheretutor`; Docker users pull
`ghcr.io/hkuds/cognispheretutor:latest`. No migrations, no configuration changes.
...
**Full Changelog**: https://github.com/HKUDS/cognisphereTutor/compare/v1.4.9...v1.4.10
